...
- **Action (规定动作)**：必须是可执行的具体操作行为（如"安装隔离开关"、"敷设电缆"、"接地"）。
...
**❌ 不应提取的"假动作"**：
- "符合"、"满足"、"达到"、"遵守" → 这些是状态描述，不是动作
- "应符合"、"应满足" → 拆分为 action: "符合" + object: "标准" 是错误的
- 简化原则：不能对应具体操作的词不要提取为 Action
